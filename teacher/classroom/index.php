...
$query = "SELECT * FROM teachers_classroom WHERE teacher_id = '$teacher_id' AND status = 'ACTIVE'";
                            ...
                            <div class="row">
                                <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                    <div class="col-xs-12 col-md-4">
                                        ...
                                        <a href="./index.php?url=eachclass&classroom_id=<?php echo $row['classroom_id']; ?>"
                                            ...
                                            <div class="card"
                                                ...
                                                <div class="box bg-info"
                                                    ...
                                                    <div class="content">
                                                        ...
                                                        <h6>
                                                            <a
                                                                href="./index.php?url=eachclass&classroom_id=<?php echo $row['classroom_id']; ?>">See
                                                                More</a>
                                                        </h6>
                                                    </div>
                                                    <div class="dboxicon">
...
<div id="classroomModal" class="modal-overlay">
    <div class="modal-container">
        ...
        <form id="classroomForm">
            ...
            <div class="form-group">
                <input type="file" id="classImage" name="classImage" class="form-control-file" accept="image/*">
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" onclick="closeClassroomModal()">Cancel</button>
                <button type="submit" class="btn btn-custom">Create Class</button>
            </div>
        </form>
    </div>
</div>
