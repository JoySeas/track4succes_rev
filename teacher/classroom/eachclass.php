                                        ...
                                        <ul class="custom-list">
                                            ...
                                            ?>
                                                ...
                                                <li class="custom-list-item <?php echo $colorClass; ?>">
                                                    ...
                                                    <div style="cursor: pointer; color: red; float: right;">
                                                        <span>
                                                            <a href="classroom/print_student.php?classroom_id=<?php echo $classroom_id; ?>&student_no=<?php echo $student['student_no']; ?>" target="_blank">
