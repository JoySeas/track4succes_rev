...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Add "ACTIVE" status to the query
    $sql = "INSERT INTO teachers_classroom (teacher_id, class_name, section, description, start_year, end_year, class_image, status, created_at) 
            VALUES (?, ?, ?, ?, ?, ?, ?, 'ACTIVE', NOW())";
