                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div style="margin-bottom: 20px;">
                            <h2 class="card-title h1proddetname"
                                style="font-weight:500; font-size: 22px;line-height: 25px; margin-bottom: 2px;"
                                id="txtprodbuynowname"></h2>
                            <h5 style="font-weight:400;">Quantity:&nbsp;<span id="txtprodbuynowqty"
                                    style="font-weight:300"></span></h5>
                        </div>

                        <h1 style="color: #f58729;line-height: 1; margin-bottom: 10px;"><span>₱</span><span
                                id="txtprodbuynowprice"></span></h1>
                        ...
                        <div class="card" style="margin-bottom: 10px;margin-top: 20px;">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h5 class="fontsizepaybot" style="font-weight: 400;"><i
                                                class="fas fa-user"></i>&nbsp;<span id="txtprodbuynowuser"></span></h5>
                                        <h5 class="fontsizepaybot" style="font-weight: 400;"><i
                                                class="fas fa-phone"></i>&nbsp;<span id="txtprodbuynowphone"></span>
                                        </h5>
                                        <h5 class="fontsizepaybot" style="font-weight: 400; margin-bottom: 0px;"><i
                                                class="fas fa-map-marker-alt"></i>&nbsp;<span
                                                id="txtprodbuynowadd"></span></h5>
                                    ...
                                    <div class="col-md-10">
                                        <div class="card" style="border: 1px solid #343a40;margin-bottom: 0px;">
                                            <div class="card-body collapse show" style="padding: .5rem;">
                                                <h4 class="card-title fontsizepaybot" style="margin-bottom: 5px;"><i
                                                        class="far fa-money-bill-alt"
                                                        style="color:#f58729;"></i>&nbsp;<span
                                                        id="txtorddetpaymenttype"></span></h4>
                                                <p class="card-text fontsizepaybot"><i class="far fa-money-bill-alt"
                                                        style="visibility: hidden;"></i>&nbsp;<span
                                                        id="txtpaymentcaption"></span></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-10">
                                        <div class="card" style="margin-bottom: 0px;">
                                            <div class="card-body collapse show" style="padding: 0rem;">
                                                <h5 style="font-weight:400;">Reference Number:&nbsp;<span
                                                        id="txtprodbuynowrefnum" style="font-weight:300"></span></h5>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <h5 class="fontsizepaybot"><span
                                                        style="font-weight: 500;">Subtotal</span> <span></span></h5>
                                            </div>
