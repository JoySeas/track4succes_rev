...
// Fetch announcements that are still valid
$sql = "SELECT * FROM announcements WHERE date >= ? ORDER BY date DESC";
...
<body>
            ...
            <div class="card" style="margin-bottom: 0px;">
                <div class="card-body" style="padding-top: .5rem; padding-bottom: .5rem; border-radius: 5px; box-shadow: 2px 3px 5px rgb(126, 142, 159);">
                    <div class="row page-titles rowpageheaderpadd" style="padding-bottom: 0px;">
                        ...
                        <a href="./index.php?url=announcementarchive">
                        <button class="btn" style="background: #2C4E80; border-radius: 10px; color: #FFFFFF; margin-top: 1rem;margin-bottom: 2rem;">See Archive</button></a>
                    </div>
                    </div>
    ...
    <?php while ($row = $result->fetch_assoc()): ?>
        <div class="announcement">
            ...
            <p><?= htmlspecialchars(truncateContent($row['content'])); ?></p>
            <p><small>Date: <?= htmlspecialchars($row['date']); ?></small></p>
        </div>
    <?php endwhile; ?>
<?php else: ?>
    <p>No current announcements available.</p>
<?php endif; ?>
